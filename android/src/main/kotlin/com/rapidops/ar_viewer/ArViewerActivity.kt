...
class ArViewerActivity : ComponentActivity() {
    ...
    private fun handleTap(
        ...
        currentFrame?.hitTest(motionEvent.x, motionEvent.y)
    ...
    private fun loadModel() {
        ...
        val anchor = currentFrame.hitTest(centerX.toFloat(), centerY.toFloat())
        ...
        if (anchor != null) {
            lifecycleScope.launch {
                try {
                    ...
                    Toast.makeText(
                        this@ArViewerActivity, "Failed to create anchor node", Toast.LENGTH_SHORT
                    ).show()
